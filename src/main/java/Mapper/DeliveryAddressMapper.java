...
public interface DeliveryAddressMapper {
    int saveDeliveryAddress(@Param("daId")Integer daId,@Param("userId")String userId,@Param("contactName")String contactName,@Param("contactSex")Integer contactSex,@Param("contactTel")String contactTel,@Param("address")String address);
